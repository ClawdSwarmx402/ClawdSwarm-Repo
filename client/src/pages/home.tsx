          ...
          <div className="absolute top-[25%] left-[5000px] text-center w-[600px]">
            ...
            <div className="bg-white/80 p-6 rounded-2xl inline-block">
              ...
              <div className="flex justify-center gap-5 items-center">
                <a href="https://t.me/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" data-testid="link-telegram">
                ...
                <a href="https://x.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" data-testid="link-x">
                ...
                <a href="https://clawdswarm.com" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" data-testid="link-website">
                ...
                <a href="https://gitbook.io/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" data-testid="link-gitbook">
                ...
                <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" data-testid="link-github">
